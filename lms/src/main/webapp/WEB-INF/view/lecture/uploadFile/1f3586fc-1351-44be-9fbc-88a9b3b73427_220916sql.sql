...
CREATE TABLE IF NOT EXISTS `employee` (
  ...
  `salary_grade` varchar(50) NOT NULL DEFAULT 'E' COMMENT '연봉등급',
  `create_date` date DEFAULT NULL,
  `update_date` date DEFAULT NULL,
  PRIMARY KEY (`employee_no`),
  KEY `FK_employee_salary` (`salary_grade`),
  CONSTRAINT `FK_employee_salary` FOREIGN KEY (`salary_grade`) REFERENCES `salary` (`salary_no`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='총관리자/서브관리자(employee_active값으로 구분)';

-- 테이블 데이터 lms.employee:~4 rows (대략적) 내보내기
DELETE FROM `employee`;
/*!40000 ALTER TABLE `employee` DISABLE KEYS */;
INSERT INTO `employee` (`employee_no`, `employee_pass`, `employee_name`, `employee_regi_no`, `employee_age`, `employee_gender`, `employee_telephone`, `employee_email`, `employee_address`, `employee_detail_address`, `employee_state`, `employee_active`, `salary_grade`, `create_date`, `update_date`) VALUES
	(141, '141', '141', '141', 12, '여자', '0109', 'asdf', '08500 서울 금천구 가마산로 70', '12', 'Y', '서브관리자', 'E', NULL, NULL);
INSERT INTO `employee` (`employee_no`, `employee_pass`, `employee_name`, `employee_regi_no`, `employee_age`, `employee_gender`, `employee_telephone`, `employee_email`, `employee_address`, `employee_detail_address`, `employee_state`, `employee_active`, `salary_grade`, `create_date`, `update_date`) VALUES
	(1001, '1234', '1234', '1234', 12, '여자', '123', '123', '', '', 'Y', '서브관리자', 'E', NULL, NULL);
INSERT INTO `employee` (`employee_no`, `employee_pass`, `employee_name`, `employee_regi_no`, `employee_age`, `employee_gender`, `employee_telephone`, `employee_email`, `employee_address`, `employee_detail_address`, `employee_state`, `employee_active`, `salary_grade`, `create_date`, `update_date`) VALUES
	(1242, '1234', 'sagas', '1234', 1, '여자', '122112521', 'asgsa', 'sagasg', 'sag', 'Y', '서브관리자', 'E', NULL, NULL);
INSERT INTO `employee` (`employee_no`, `employee_pass`, `employee_name`, `employee_regi_no`, `employee_age`, `employee_gender`, `employee_telephone`, `employee_email`, `employee_address`, `employee_detail_address`, `employee_state`, `employee_active`, `salary_grade`, `create_date`, `update_date`) VALUES
	(200001, '1234', '김히언', '940309', 30, '여자', '010-2222-2222', 'KHW999@naver.com', '서울특별시 은평구', '북가좌동 무슨아파트 무슨호', 'Y', '서브관리자', 'E', NULL, NULL);
...
-- 테이블 데이터 lms.professor:~1 rows (대략적) 내보내기
DELETE FROM `professor`;
/*!40000 ALTER TABLE `professor` DISABLE KEYS */;
INSERT INTO `professor` (`professor_no`, `professor_pass`, `major_no`, `professor_name`, `professor_regi_no`, `professor_age`, `professor_gender`, `professor_telephone`, `professor_email`, `professor_address`, `professor_detail_address`, `professor_room`, `professor_state`, `salary_no`, `create_date`, `update_date`) VALUES
	(100001, '1234', 1001, '박성환', '600915-111111', 62, '남자', '010-1234-1234', 'parksh@naver.com', '서울특별시 금천구', '세진이노플렉스3층', NULL, 'Y', 'D', NULL, NULL);
...
-- 테이블 데이터 lms.salary:~2 rows (대략적) 내보내기
DELETE FROM `salary`;
/*!40000 ALTER TABLE `salary` DISABLE KEYS */;
INSERT INTO `salary` (`salary_no`, `salary_value`) VALUES
	('D', 99);
INSERT INTO `salary` (`salary_no`, `salary_value`) VALUES
	('E', 90);
...
-- 테이블 데이터 lms.student:~1 rows (대략적) 내보내기
DELETE FROM `student`;
/*!40000 ALTER TABLE `student` DISABLE KEYS */;
INSERT INTO `student` (`student_no`, `student_pass`, `major_no`, `student_name`, `student_regi_no`, `student_age`, `student_gender`, `student_telephone`, `student_email`, `student_address`, `student_detail_address`, `student_state`, `student_top`, `student_active`, `club_no`, `scholar_no`, `create_date`, `update_date`) VALUES
	(300001, '1234', 1005, '김희원', '000209-222222', 23, '여자', '010-2222-2222', 'khw001@naver.com', '서울특별시 동작구', '어떤 아파트 102동 1209호', '재학', 'N', 'Y', NULL, NULL, NULL, NULL);
...
CREATE TABLE IF NOT EXISTS `subject` (
  ...
  `subject_major` varchar(50) NOT NULL COMMENT '전필여부',
