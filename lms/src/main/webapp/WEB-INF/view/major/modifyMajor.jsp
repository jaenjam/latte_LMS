                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="form-validation">
                                    <form class="form-valide" action="${pageContext.request.contextPath}/modefyMajor" method="post">
                                        <div class="form-group row">
                                            <label class="col-lg-2 col-form-label" for="noticeNo">학과코드<span class="text-danger">*</span>
                                            </label>
                                            <div class="col-lg-10">
