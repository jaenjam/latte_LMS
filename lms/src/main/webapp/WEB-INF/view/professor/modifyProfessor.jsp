											...
											<c:forEach var="M" items="${professor}">
												<div class="form-group">
													<label> 교수사번: </label> <input type="text"
														...
														value="${M.professorNo}" readonly="readonly">
												</div>
												<div class="form-group">
													<label> 교수이름: </label> <input type="text"
												...
												<div class="form-group">
													...
													<label> 전공: </label> <input type="text"
														class="form-control" name="majorNo" id="majorNo"
													...
													<div class="col-sm-10">
														<div class="form-group">
															<label> 상세주소: </label> <input type="text"
																...
																value="${M.professorDetailAddress}">
														</div>
													</div>
													<div class="col-sm-2">
														<button type="button"
												...
												<div class="form-group">
													...
													<c:if test="${M.professorState eq 'N'}">
														<input type="text" class="form-control"
