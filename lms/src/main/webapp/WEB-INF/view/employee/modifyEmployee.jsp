		...
		<div class="container-fluid">
							...
							<div class="row mb-8">
								...
								<c:if test="${empty employeeImg}">
									...
									<c:forEach var="i" items="${employeeImg}">
										<c:if test="${i.filename ne null}">
											<form
												action="${pageContext.request.contextPath}/employee/modifyEmployeeImg">
			...
			<!-- 사진부분 -->
				...
				<div class="col-lg-8 col-xl-9">
					<div class="card">
						<div class="card-body">
							<form action="${pageContext.request.contextPath}/modifyEmployee" method="post" class="form-profile">
										...
										<c:forEach var="i" items="${employeeOne}">
												...
												<div class="form-group">
													<label>등급</label> <input type="text" class="form-control"
														...
														value="${i.employeeActive}" readonly="readonly">
												</div>
												<div class="form-group">
													<label>사번</label> <input type="text" class="form-control"
														name="employeeNo" id="employeeNo" value="${i.employeeNo}" readonly="readonly">
												</div>
												<div class="form-group">
													<label>이름</label> <input type="text" class="form-control"
														name="employeeName" id="employeeName" value="${i.employeeName}">
												</div>

												<div class="form-group">
													<label>주민번호</label> <input type="text"
														class="form-control" name="employeeRegiNo"
														id="employeeRegiNo" value="${i.employeeRegiNo}" readonly="readonly">
												</div>

												<div class="form-group">
													<label>나이</label> <input type="text" class="form-control"
														name="employeeAge" id="employeeAge" value="${i.employeeAge}"
														readonly>
												</div>
												...
												<div style="float:right">
													<button type="submit" class="btn btn-primary px-3 ml-4">수정완료</button>
												</div>
											</div>
										</div>
